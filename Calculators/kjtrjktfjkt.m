function varargout = kjtrjktfjkt(varargin)
% KJTRJKTFJKT MATLAB code for kjtrjktfjkt.fig
%      KJTRJKTFJKT, by itself, creates a new KJTRJKTFJKT or raises the existing
%      singleton*.
%
%      H = KJTRJKTFJKT returns the handle to a new KJTRJKTFJKT or the handle to
%      the existing singleton*.
%
%      KJTRJKTFJKT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in KJTRJKTFJKT.M with the given input arguments.
%
%      KJTRJKTFJKT('Property','Value',...) creates a new KJTRJKTFJKT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before kjtrjktfjkt_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to kjtrjktfjkt_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help kjtrjktfjkt

% Last Modified by GUIDE v2.5 01-Feb-2016 00:11:20

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @kjtrjktfjkt_OpeningFcn, ...
                   'gui_OutputFcn',  @kjtrjktfjkt_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before kjtrjktfjkt is made visible.
function kjtrjktfjkt_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to kjtrjktfjkt (see VARARGIN)

% Choose default command line output for kjtrjktfjkt
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes kjtrjktfjkt wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = kjtrjktfjkt_OutputFcn(hObject, eventdata, handles) 
